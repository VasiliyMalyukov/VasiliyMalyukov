...
## My hardskills:
Testing theory, test design, software life cycle, client-server architecture, Linux, Windows, Python, Java, HTML, CSS, SQL, Jira, Git, GitHub, Postman, DevTools,  Visual Studio Code, IntelliJ IDEA
